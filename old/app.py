...
# Route to select one worker doi (can not be repeated). TO BE USED IN THE FUTURE.
@app.route('/check_exist/<doi>', methods=["POST", "PUT"])
def check_exist(doi): 
...
if __name__ == '__main__':
    ...
    app.run(port=5000, host="192.168.0.19", debug=True, use_reloader=False)
